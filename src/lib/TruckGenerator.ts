...
export class TruckGenerator {
    ...
    public drawPicture(
        ...
        for (var i = 0; i <= instances; i++) {
            ...
            this.ctx.rect(
                0.05 * this.c.width + x,
                0.1155 * this.c.height,
                0.53 * this.c.width,
                0.5256 * this.c.height
            );
            this.ctx.rect(
                0.58 * this.c.width + x,
                0.3064 * this.c.height,
                0.28 * this.c.width,
                0.3346 * this.c.height
            );
            this.ctx.stroke();
            //Code for drawing container wheels
            this.ctx.beginPath();
            this.ctx.arc(
                0.7251 * this.c.width + x,
                0.7336 * this.c.height,
                0.08547 * this.c.height,
                0,
                2 * Math.PI
            );
            this.ctx.stroke();
            ...
            this.ctx.fillText(
                container,
                0.08241 * this.c.width + x,
                0.26915 * this.c.height,
                0.46058 * this.c.width
            );
            ...
            this.ctx.fillText(
                ...
                0.69481 * this.c.width,
                0.98291 * this.c.height
            );
